    ...
    public async create(request: Request, response: Response): Promise<Response> {
        try {
            ...
            if (result) {
                ...
                if (!result) {
                    const advisorEntity: AdvisorEntity =
                        await advisorService.create(request.body);
        ...
        try {
            ...
            if (Number(request.params.id)) {
                ...
                if (result) {
                    ...
                    if (result) {
                        const advisorEntity: AdvisorEntity =
                            await advisorService.update(Number(request.params.id), request.body);
        ...
        try {
            ...
            if (Number(request.params.id)) {
                const deleteResult: DeleteResult =
                    await advisorService.delete(Number(request.params.id));
