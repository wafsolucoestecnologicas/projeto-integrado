    ...
    public async create(request: Request, response: Response): Promise<Response> {
        try {
            ...
            if (result) {
                ...
                if (!result) {
                    const brokerEntity: BrokerEntity =
                        await brokerService.create(request.body);
        ...
        try {
            ...
            if (Number(request.params.id)) {
                ...
                if (result) {
                    ...
                    if (result) {
                        const brokerEntity: BrokerEntity =
                            await brokerService.update(Number(request.params.id), request.body);
        ...
        try {
            ...
            if (Number(request.params.id)) {
                const deleteResult: DeleteResult =
                    await brokerService.delete(Number(request.params.id));
