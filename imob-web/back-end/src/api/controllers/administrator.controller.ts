    ...
    public async create(request: Request, response: Response): Promise<Response> {
        try {
            ...
            if (result) {
                ...
                if (!result) {
                    const administratorEntity: AdministratorEntity =
                        await administratorService.create(request.body);
        ...
        try {
            ...
            if (Number(request.params.id)) {
                ...
                if (result) {
                    ...
                    if (result) {
                        const administratorEntity: AdministratorEntity =
                            await administratorService.update(Number(request.params.id), request.body);
        ...
        try {
            ...
            if (Number(request.params.id)) {
                const deleteResult: DeleteResult =
                    await administratorService.delete(Number(request.params.id));
