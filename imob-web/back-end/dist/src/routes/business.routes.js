...
var business_controller_1 = require("../api/controllers/business.controller");
var multer_1 = __importDefault(require("../../config/multer"));
var businessController = new business_controller_1.BusinessController();
var router = (0, express_1.Router)();
router.post('/upload', multer_1.default.single('file'), businessController.upload);
