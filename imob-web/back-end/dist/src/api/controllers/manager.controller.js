...
var ManagerController = /** @class */ (function () {
    ...
    ManagerController.prototype.index = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var managerService, managerEntity, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        managerService = new manager_service_1.ManagerService();
                        return [4 /*yield*/, managerService.index(request.payload)];
                    case 1:
                        managerEntity = _a.sent();
                        return [2 /*return*/, response.status(200).json(managerEntity)];
                    case 2:
                        error_1 = _a.sent();
    ...
    ManagerController.prototype.create = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, typeorm_1.getManager)().transaction(function (transaction) { return __awaiter(_this, void 0, void 0, function () {
                            var managerService, result, result_1, managerEntity, error_2;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        _a.trys.push([0, 7, , 8]);
                                        managerService = new manager_service_1.ManagerService();
                                        result = managerService.validateData(request.body);
                                        if (!result) return [3 /*break*/, 5];
                                        return [4 /*yield*/, managerService.alreadyRegisterByCPF(request.body.cpf)];
                                    case 1:
                                        result_1 = _a.sent();
                                        if (!!result_1) return [3 /*break*/, 3];
                                        return [4 /*yield*/, managerService.create(request.body, transaction)];
                                    case 2:
                                        managerEntity = _a.sent();
                                        return [2 /*return*/, response.status(201).json(managerEntity)];
    ...
    ManagerController.prototype.read = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var managerService, managerEntity, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        ...
                        return [4 /*yield*/, managerService.read(Number(request.params.id), request.payload)];
                    case 1:
                        managerEntity = _a.sent();
                        return [2 /*return*/, response.status(200).json(managerEntity)];
    ...
    ManagerController.prototype.update = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, typeorm_1.getManager)().transaction(function (transaction) { return __awaiter(_this, void 0, void 0, function () {
                            var managerService, result, result_2, managerEntity, error_4;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        _a.trys.push([0, 9, , 10]);
                                        ...
                                        return [4 /*yield*/, managerService.alreadyRegisterById(Number(request.params.id))];
                                    case 1:
                                        result = _a.sent();
                                        if (!result) return [3 /*break*/, 5];
                                        result_2 = managerService.validateData(request.body);
                                        if (!result_2) return [3 /*break*/, 3];
                                        return [4 /*yield*/, managerService.update(Number(request.params.id), request.body, transaction)];
                                    case 2:
                                        managerEntity = _a.sent();
                                        return [2 /*return*/, response.status(200).json(managerEntity)];
    ...
    ManagerController.prototype.delete = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, typeorm_1.getManager)().transaction(function (transaction) { return __awaiter(_this, void 0, void 0, function () {
                            var managerService, managerEntity, userService, userEntity, userDeleteResult, managerDeleteResult, error_5;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                    ...
                                    case 1:
                                        managerEntity = _a.sent();
                                        if (!managerEntity) return [3 /*break*/, 7];
                                        userService = new user_service_1.UserService();
                                        return [4 /*yield*/, userService.findByManager(Number(request.params.id))];
                                    case 2:
                                        userEntity = _a.sent();
                                    ...
                                    case 3:
                                        ...
                                        return [4 /*yield*/, managerService.delete(Number(request.params.id), transaction)];
                                    case 4:
                                        managerDeleteResult = _a.sent();
