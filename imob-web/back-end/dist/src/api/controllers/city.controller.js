...
var CityController = /** @class */ (function () {
    ...
    CityController.prototype.index = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var cityService, cityEntity, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        cityService = new city_service_1.CityService();
                        return [4 /*yield*/, cityService.index()];
                    case 1:
                        cityEntity = _a.sent();
                        return [2 /*return*/, response.status(200).json(cityEntity)];
                    case 2:
                        error_1 = _a.sent();
    ...
    CityController.prototype.create = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, typeorm_1.getManager)().transaction(function (transaction) { return __awaiter(_this, void 0, void 0, function () {
                            var cityService, result, cityEntity, error_2;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        _a.trys.push([0, 4, , 5]);
                                        cityService = new city_service_1.CityService();
                                        result = cityService.validateData(request.body);
                                        if (!result) return [3 /*break*/, 2];
                                        return [4 /*yield*/, cityService.create(request.body, transaction)];
                                    case 1:
                                        cityEntity = _a.sent();
                                        return [2 /*return*/, response.status(201).json(cityEntity)];
    ...
    CityController.prototype.read = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var cityService, cityEntity, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        ...
                        return [4 /*yield*/, cityService.read(Number(request.params.id))];
                    case 1:
                        cityEntity = _a.sent();
                        return [2 /*return*/, response.status(200).json(cityEntity)];
    ...
    CityController.prototype.update = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, typeorm_1.getManager)().transaction(function (transaction) { return __awaiter(_this, void 0, void 0, function () {
                            var cityService, result, result_1, cityEntity, error_4;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        _a.trys.push([0, 9, , 10]);
                                        ...
                                        return [4 /*yield*/, cityService.alreadyRegisterById(Number(request.params.id))];
                                    case 1:
                                        result = _a.sent();
                                        if (!result) return [3 /*break*/, 5];
                                        result_1 = cityService.validateData(request.body);
                                        if (!result_1) return [3 /*break*/, 3];
                                        return [4 /*yield*/, cityService.update(Number(request.params.id), request.body, transaction)];
                                    case 2:
                                        cityEntity = _a.sent();
                                        return [2 /*return*/, response.status(200).json(cityEntity)];
    ...
    CityController.prototype.delete = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, typeorm_1.getManager)().transaction(function (transaction) { return __awaiter(_this, void 0, void 0, function () {
                            var cityService, deleteResult, error_5;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        _a.trys.push([0, 4, , 5]);
                                        cityService = new city_service_1.CityService();
                                        if (!Number(request.params.id)) return [3 /*break*/, 2];
                                        return [4 /*yield*/, cityService.delete(Number(request.params.id), transaction)];
                                    case 1:
                                        deleteResult = _a.sent();
                                        return [2 /*return*/, response.status(200).json({ city: deleteResult.affected })];
                                    case 2: return [2 /*return*/, response.status(400).json({ message: utils_1.statusMessages[400] + " " + utils_1.returnMessages[2] })];
                                    case 3: return [3 /*break*/, 5];
                                    case 4:
                                        error_5 = _a.sent();
