            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, userService.index()];
                    case 1:
                        userEntity = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, userService.read(Number(request.params.id))];
                    case 1:
                        userEntity = _a.sent();
                        if (userEntity)
                            userEntity.password = '';
    ...
    UserController.prototype.delete = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, typeorm_1.getManager)().transaction(function (transaction) { return __awaiter(_this, void 0, void 0, function () {
                            var userService, userEntity, companyService, companyId, personId, userDeleteResult, personDeleteResult, _a, administratorService, managerService, advisorService, brokerService, secretaryService, companyDeleteResult, error_5;
                            var _b, _c, _d, _e, _f;
                            return __generator(this, function (_g) {
                                switch (_g.label) {
                                    case 0:
                                        ...
                                        userService = new user_service_1.UserService();
                                        if (!Number(request.params.id)) return [3 /*break*/, 17];
                                        return [4 /*yield*/, userService.read(Number(request.params.id))];
                                    case 1:
                                        userEntity = _g.sent();
                                        if (!userEntity) return [3 /*break*/, 15];
                                        companyService = new company_service_1.CompanyService();
                                    ...
                                    case 12:
                                        personDeleteResult =
                                            _g.sent();
                                        return [3 /*break*/, 13];
                                    case 13: return [4 /*yield*/, companyService.delete(companyId, transaction)];
                                    case 14:
                                        companyDeleteResult = _g.sent();
                                    ...
                                    case 15: return [2 /*return*/, response.status(400).json({ message: utils_1.statusMessages[400] + " " + utils_1.returnMessages[1] })];
                                    case 16: return [3 /*break*/, 18];
                                    case 17: return [2 /*return*/, response.status(400).json({ message: utils_1.statusMessages[400] + " " + utils_1.returnMessages[2] })];
