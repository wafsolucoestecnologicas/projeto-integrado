...
var CompanyController = /** @class */ (function () {
    ...
    CompanyController.prototype.index = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var companyService, companyEntity, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        companyService = new company_service_1.CompanyService();
                        return [4 /*yield*/, companyService.index(request.payload)];
                    case 1:
                        companyEntity = _a.sent();
                        return [2 /*return*/, response.status(200).json(companyEntity)];
                    case 2:
                        error_1 = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, typeorm_1.getManager)().transaction(function (transaction) { return __awaiter(_this, void 0, void 0, function () {
                            var companyService, result, result_1, companyEntity, error_2;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        _a.trys.push([0, 7, , 8]);
                                        companyService = new company_service_1.CompanyService();
                                        result = companyService.validateData(request.body);
                                        if (!result) return [3 /*break*/, 5];
                                        return [4 /*yield*/, companyService.alreadyRegisteredByCNPJ(request.body.cnpj)];
                                    case 1:
                                        result_1 = _a.sent();
                                        if (!!result_1) return [3 /*break*/, 3];
                                        return [4 /*yield*/, companyService.create(request.body, transaction)];
                                    case 2:
                                        companyEntity = _a.sent();
                                        return [2 /*return*/, response.status(201).json(companyEntity)];
    ...
    CompanyController.prototype.read = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var companyService, companyEntity, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        ...
                        return [4 /*yield*/, companyService.read(Number(request.params.id))];
                    case 1:
                        companyEntity = _a.sent();
                        return [2 /*return*/, response.status(200).json(companyEntity)];
    ...
    CompanyController.prototype.update = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, typeorm_1.getManager)().transaction(function (transaction) { return __awaiter(_this, void 0, void 0, function () {
                            var companyService, result, result_2, companyEntity, error_4;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        _a.trys.push([0, 9, , 10]);
                                        ...
                                        return [4 /*yield*/, companyService.alreadyRegisteredById(Number(request.params.id))];
                                    case 1:
                                        result = _a.sent();
                                        if (!result) return [3 /*break*/, 5];
                                        result_2 = companyService.validateData(request.body);
                                        if (!result_2) return [3 /*break*/, 3];
                                        return [4 /*yield*/, companyService.update(Number(request.params.id), request.body, transaction)];
                                    case 2:
                                        companyEntity = _a.sent();
                                        return [2 /*return*/, response.status(200).json(companyEntity)];
    ...
    CompanyController.prototype.delete = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, typeorm_1.getManager)().transaction(function (transaction) { return __awaiter(_this, void 0, void 0, function () {
                            var companyService, deleteResult, error_5;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        _a.trys.push([0, 4, , 5]);
                                        companyService = new company_service_1.CompanyService();
                                        if (!Number(request.params.id)) return [3 /*break*/, 2];
                                        return [4 /*yield*/, companyService.delete(Number(request.params.id), transaction)];
                                    case 1:
                                        deleteResult = _a.sent();
                                        return [2 /*return*/, response.status(200).json({ company: deleteResult.affected })];
                                    case 2: return [2 /*return*/, response.status(400).json({ message: utils_1.statusMessages[400] + " " + utils_1.returnMessages[2] })];
                                    case 3: return [3 /*break*/, 5];
                                    case 4:
                                        error_5 = _a.sent();
