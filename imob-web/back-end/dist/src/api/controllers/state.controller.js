...
var StateController = /** @class */ (function () {
    ...
    StateController.prototype.index = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var stateService, stateEntity, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        stateService = new state_service_1.StateService();
                        return [4 /*yield*/, stateService.index()];
                    case 1:
                        stateEntity = _a.sent();
                        return [2 /*return*/, response.status(200).json(stateEntity)];
                    case 2:
                        error_1 = _a.sent();
    ...
    StateController.prototype.read = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var stateService, stateEntity, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        ...
                        return [4 /*yield*/, stateService.read(Number(request.params.id))];
                    case 1:
                        stateEntity = _a.sent();
                        return [2 /*return*/, response.status(200).json(stateEntity)];
