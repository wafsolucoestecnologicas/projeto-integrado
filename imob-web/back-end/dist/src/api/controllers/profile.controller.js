...
var ProfileController = /** @class */ (function () {
    ...
    ProfileController.prototype.index = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var profileService, profileEntity, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        profileService = new profile_service_1.ProfileService();
                        return [4 /*yield*/, profileService.index()];
                    case 1:
                        profileEntity = _a.sent();
                        return [2 /*return*/, response.status(200).json(profileEntity)];
                    case 2:
                        error_1 = _a.sent();
    ...
    ProfileController.prototype.read = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var profileService, profileEntity, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        ...
                        return [4 /*yield*/, profileService.read(Number(request.params.id))];
                    case 1:
                        profileEntity = _a.sent();
                        return [2 /*return*/, response.status(200).json(profileEntity)];
