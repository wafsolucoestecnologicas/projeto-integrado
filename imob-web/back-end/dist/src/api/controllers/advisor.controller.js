...
var AdvisorController = /** @class */ (function () {
    function AdvisorController() {
    }
    AdvisorController.prototype.index = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var advisorService, advisorEntity, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        advisorService = new advisor_service_1.AdvisorService();
                        return [4 /*yield*/, advisorService.index(request.payload)];
                    case 1:
                        advisorEntity = _a.sent();
                        return [2 /*return*/, response.status(200).json(advisorEntity)];
                    case 2:
                        error_1 = _a.sent();
    ...
    AdvisorController.prototype.create = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, typeorm_1.getManager)().transaction(function (transaction) { return __awaiter(_this, void 0, void 0, function () {
                            var advisorService, result, result_1, advisorEntity, error_2;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        _a.trys.push([0, 7, , 8]);
                                        advisorService = new advisor_service_1.AdvisorService();
                                        result = advisorService.validateData(request.body);
                                        if (!result) return [3 /*break*/, 5];
                                        return [4 /*yield*/, advisorService.alreadyRegisterByCPF(request.body.cpf)];
                                    case 1:
                                        result_1 = _a.sent();
                                        if (!!result_1) return [3 /*break*/, 3];
                                        return [4 /*yield*/, advisorService.create(request.body, transaction)];
                                    case 2:
                                        advisorEntity = _a.sent();
                                        return [2 /*return*/, response.status(201).json(advisorEntity)];
    ...
    AdvisorController.prototype.read = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var advisorService, advisorEntity, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        ...
                        return [4 /*yield*/, advisorService.read(Number(request.params.id), request.payload)];
                    case 1:
                        advisorEntity = _a.sent();
                        return [2 /*return*/, response.status(200).json(advisorEntity)];
    ...
    AdvisorController.prototype.update = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, typeorm_1.getManager)().transaction(function (transaction) { return __awaiter(_this, void 0, void 0, function () {
                            var advisorService, result, result_2, advisorEntity, error_4;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        _a.trys.push([0, 9, , 10]);
                                        ...
                                        return [4 /*yield*/, advisorService.alreadyRegisterById(Number(request.params.id))];
                                    case 1:
                                        result = _a.sent();
                                        if (!result) return [3 /*break*/, 5];
                                        result_2 = advisorService.validateData(request.body);
                                        if (!result_2) return [3 /*break*/, 3];
                                        return [4 /*yield*/, advisorService.update(Number(request.params.id), request.body, transaction)];
                                    case 2:
                                        advisorEntity = _a.sent();
                                        return [2 /*return*/, response.status(200).json(advisorEntity)];
    ...
    AdvisorController.prototype.delete = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, typeorm_1.getManager)().transaction(function (transaction) { return __awaiter(_this, void 0, void 0, function () {
                            var advisorService, advisorEntity, userService, userEntity, userDeleteResult, advisorDeleteResult, error_5;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                    ...
                                    case 1:
                                        advisorEntity = _a.sent();
                                        if (!advisorEntity) return [3 /*break*/, 7];
                                        userService = new user_service_1.UserService();
                                        return [4 /*yield*/, userService.findByAdvisor(Number(request.params.id))];
                                    case 2:
                                        userEntity = _a.sent();
                                    ...
                                    case 3:
                                        ...
                                        return [4 /*yield*/, advisorService.delete(Number(request.params.id), transaction)];
                                    case 4:
                                        advisorDeleteResult = _a.sent();
