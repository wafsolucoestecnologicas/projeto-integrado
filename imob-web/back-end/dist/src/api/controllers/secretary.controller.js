...
var SecretaryController = /** @class */ (function () {
    ...
    SecretaryController.prototype.index = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var secretaryService, secretaryEntity, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        secretaryService = new secretary_service_1.SecretaryService();
                        return [4 /*yield*/, secretaryService.index(request.payload)];
                    case 1:
                        secretaryEntity = _a.sent();
                        return [2 /*return*/, response.status(200).json(secretaryEntity)];
                    case 2:
                        error_1 = _a.sent();
    ...
    SecretaryController.prototype.create = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, typeorm_1.getManager)().transaction(function (transaction) { return __awaiter(_this, void 0, void 0, function () {
                            var secretaryService, result, result_1, secretaryEntity, error_2;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        _a.trys.push([0, 7, , 8]);
                                        secretaryService = new secretary_service_1.SecretaryService();
                                        result = secretaryService.validateData(request.body);
                                        if (!result) return [3 /*break*/, 5];
                                        return [4 /*yield*/, secretaryService.alreadyRegisterByCPF(request.body.cpf)];
                                    case 1:
                                        result_1 = _a.sent();
                                        if (!!result_1) return [3 /*break*/, 3];
                                        return [4 /*yield*/, secretaryService.create(request.body, transaction)];
                                    case 2:
                                        secretaryEntity = _a.sent();
                                        return [2 /*return*/, response.status(201).json(secretaryEntity)];
    ...
    SecretaryController.prototype.read = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var secretaryService, secretaryEntity, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        ...
                        return [4 /*yield*/, secretaryService.read(Number(request.params.id), request.payload)];
                    case 1:
                        secretaryEntity = _a.sent();
                        return [2 /*return*/, response.status(200).json(secretaryEntity)];
    ...
    SecretaryController.prototype.update = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, typeorm_1.getManager)().transaction(function (transaction) { return __awaiter(_this, void 0, void 0, function () {
                            var secretaryService, result, result_2, secretaryEntity, error_4;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        _a.trys.push([0, 9, , 10]);
                                        ...
                                        return [4 /*yield*/, secretaryService.alreadyRegisterById(Number(request.params.id))];
                                    case 1:
                                        result = _a.sent();
                                        if (!result) return [3 /*break*/, 5];
                                        result_2 = secretaryService.validateData(request.body);
                                        if (!result_2) return [3 /*break*/, 3];
                                        return [4 /*yield*/, secretaryService.update(Number(request.params.id), request.body, transaction)];
                                    case 2:
                                        secretaryEntity = _a.sent();
                                        return [2 /*return*/, response.status(200).json(secretaryEntity)];
    ...
    SecretaryController.prototype.delete = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, typeorm_1.getManager)().transaction(function (transaction) { return __awaiter(_this, void 0, void 0, function () {
                            var secretaryService, secretaryEntity, userService, userEntity, userDeleteResult, secretaryDeleteResult, error_5;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                    ...
                                    case 1:
                                        secretaryEntity = _a.sent();
                                        if (!secretaryEntity) return [3 /*break*/, 7];
                                        userService = new user_service_1.UserService();
                                        return [4 /*yield*/, userService.findBySecretary(Number(request.params.id))];
                                    case 2:
                                        userEntity = _a.sent();
                                    ...
                                    case 3:
                                        ...
                                        return [4 /*yield*/, secretaryService.delete(Number(request.params.id), transaction)];
                                    case 4:
                                        secretaryDeleteResult = _a.sent();
