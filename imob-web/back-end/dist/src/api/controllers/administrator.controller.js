...
var AdministratorController = /** @class */ (function () {
    ...
    AdministratorController.prototype.index = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var administratorService, administratorEntity, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        administratorService = new administrator_service_1.AdministratorService();
                        return [4 /*yield*/, administratorService.index()];
                    case 1:
                        administratorEntity = _a.sent();
                        return [2 /*return*/, response.status(200).json(administratorEntity)];
                    case 2:
                        error_1 = _a.sent();
    ...
    AdministratorController.prototype.create = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, typeorm_1.getManager)().transaction(function (transaction) { return __awaiter(_this, void 0, void 0, function () {
                            var administratorService, result, result_1, administratorEntity, error_2;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        _a.trys.push([0, 7, , 8]);
                                        administratorService = new administrator_service_1.AdministratorService();
                                        result = administratorService.validateData(request.body);
                                        if (!result) return [3 /*break*/, 5];
                                        return [4 /*yield*/, administratorService.alreadyRegisterByCPF(request.body.cpf)];
                                    case 1:
                                        result_1 = _a.sent();
                                        if (!!result_1) return [3 /*break*/, 3];
                                        return [4 /*yield*/, administratorService.create(request.body, transaction)];
                                    case 2:
                                        administratorEntity = _a.sent();
                                        return [2 /*return*/, response.status(201).json(administratorEntity)];
    ...
    AdministratorController.prototype.read = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var administratorService, administratorEntity, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        ...
                        return [4 /*yield*/, administratorService.read(Number(request.params.id))];
                    case 1:
                        administratorEntity = _a.sent();
                        return [2 /*return*/, response.status(200).json(administratorEntity)];
    ...
    AdministratorController.prototype.update = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, typeorm_1.getManager)().transaction(function (transaction) { return __awaiter(_this, void 0, void 0, function () {
                            var administratorService, result, result_2, administratorEntity, error_4;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        _a.trys.push([0, 9, , 10]);
                                        ...
                                        return [4 /*yield*/, administratorService.alreadyRegisterById(Number(request.params.id))];
                                    case 1:
                                        result = _a.sent();
                                        if (!result) return [3 /*break*/, 5];
                                        result_2 = administratorService.validateData(request.body);
                                        if (!result_2) return [3 /*break*/, 3];
                                        return [4 /*yield*/, administratorService.update(Number(request.params.id), request.body, transaction)];
                                    case 2:
                                        administratorEntity = _a.sent();
                                        return [2 /*return*/, response.status(200).json(administratorEntity)];
    ...
    AdministratorController.prototype.delete = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, typeorm_1.getManager)().transaction(function (transaction) { return __awaiter(_this, void 0, void 0, function () {
                            var administratorService, administratorEntity, userService, userEntity, userDeleteResult, administratorDeleteResult, error_5;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                    ...
                                    case 1:
                                        administratorEntity = _a.sent();
                                        if (!administratorEntity) return [3 /*break*/, 7];
                                        userService = new user_service_1.UserService();
                                        return [4 /*yield*/, userService.findByAdministrator(Number(request.params.id))];
                                    case 2:
                                        userEntity = _a.sent();
                                    ...
                                    case 3:
                                        ...
                                        return [4 /*yield*/, administratorService.delete(Number(request.params.id), transaction)];
                                    case 4:
                                        administratorDeleteResult = _a.sent();
