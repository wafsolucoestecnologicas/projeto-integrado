...
describe("Suíte de testes do módulo de secretária", function () {
    var connection;
    var payload;
    var company;
    var secretary;
    ...
    test("Buscando por uma ou mais secretárias de uma imobiliária", function () { return __awaiter(void 0, void 0, void 0, function () {
        var expected;
        return __generator(this, function (_a) {
            expected = 1;
            company.id = 1;
    ...
    test("Criando uma nova secretária", function () { return __awaiter(void 0, void 0, void 0, function () {
        var expected;
        return __generator(this, function (_a) {
            expected = secretary;
            company.id = 1;
    ...
    test("Buscando por um secretária de uma imobiliária", function () { return __awaiter(void 0, void 0, void 0, function () {
        var expected, id;
        return __generator(this, function (_a) {
            expected = secretary;
            id = 6;
    ...
    test("Atualizando um secretária de uma imobiliária", function () { return __awaiter(void 0, void 0, void 0, function () {
        var expected, id;
        return __generator(this, function (_a) {
            expected = secretary;
            id = 6;
    ...
    test("Deletando um secretária de uma imobiliária", function () { return __awaiter(void 0, void 0, void 0, function () {
        var expected, id;
        return __generator(this, function (_a) {
            expected = 1;
            id = 6;
    ...
    test("Validando dados de um secretária", function () {
        var expected = true;
    ...
    test("Verificando se existe um secretária cadastrado através do CPF", function () { return __awaiter(void 0, void 0, void 0, function () {
        var expected, CPF;
        return __generator(this, function (_a) {
            expected = true;
            CPF = "85718872090";
    ...
    test("Verificando se existe um secretária cadastrado através do ID", function () { return __awaiter(void 0, void 0, void 0, function () {
        var expected, id;
        return __generator(this, function (_a) {
            expected = true;
            id = 6;
