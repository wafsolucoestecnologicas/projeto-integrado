...
var company_service_1 = require("../src/api/services/company.service");
var payload_class_1 = require("../utils/classes/payload.class");
describe("Suíte de testes do módulo de imobiliária", function () {
    var connection;
    var payload;
    var company;
    var service;
    ...
    test("Buscando por uma ou mais imobiliárias", function () { return __awaiter(void 0, void 0, void 0, function () {
        var expected;
        return __generator(this, function (_a) {
            expected = 1;
            company.id = 1;
    ...
    test("Criando um nova imobiliária", function () { return __awaiter(void 0, void 0, void 0, function () {
        var expected;
        return __generator(this, function (_a) {
            expected = company;
            ...
            connection.transaction(function (transaction) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, service.create(company, transaction)];
                        case 1:
                            result = _a.sent();
    ...
    test("Buscando por uma imobiliária", function () { return __awaiter(void 0, void 0, void 0, function () {
        var expected, id;
        return __generator(this, function (_a) {
            expected = company;
            id = 1;
    ...
    test("Atualizando uma imobiliária", function () { return __awaiter(void 0, void 0, void 0, function () {
        var expected, id;
        return __generator(this, function (_a) {
            expected = company;
            id = 1;
            ...
            connection.transaction(function (transaction) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, service.update(id, company, transaction)];
                        case 1:
                            result = _a.sent();
                            expect(result).toBe(expected);
                            return [2 /*return*/];
    ...
    test("Deletando uma imobiliária", function () { return __awaiter(void 0, void 0, void 0, function () {
        var expected, id;
        return __generator(this, function (_a) {
            expected = 1;
            id = 1;
    ...
    test("Criando imobiliária através de um repositório", function () {
        var actual = service.createCompanyEntityByRepository({
            CNPJ: "53556773000115",
            corporateName: "Carla e Raimundo Financeira ME",
            stateRegistration: "170778882221",
        });
        expect(actual).toBeInstanceOf(company_entity_1.CompanyEntity);
    });
    test("Validando dados de uma imobiliária", function () {
        var expected = true;
    ...
    test("Verificando se existe uma imobiliária cadastrada através do CNPJ", function () { return __awaiter(void 0, void 0, void 0, function () {
        var expected, CNPJ;
        return __generator(this, function (_a) {
            expected = true;
            CNPJ = "72850186000189";
            connection.transaction(function (transaction) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, service.alreadyRegisteredByCNPJ(CNPJ)];
                        case 1:
                            result = _a.sent();
                            expect(result).toBe(expected);
                            return [2 /*return*/];
    ...
    test("Verificando se existe uma imobiliária cadastrada através do ID", function () { return __awaiter(void 0, void 0, void 0, function () {
        var expected, id;
        return __generator(this, function (_a) {
            expected = true;
            id = 1;
